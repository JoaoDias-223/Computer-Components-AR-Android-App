            ...
            while((line = reader.readLine()) != null){
                ...
                if(parts[0].equals("newmtl")){
                    if(mtl == 4){
                        ...
                        /*Log.d(TAG, "Material:" +
                                "\n name = " + ListOfMaterials.get(name).getName() +
                                "\n ambient = (" + ListOfMaterials.get(name).getAmbient()[0] + ", " + ListOfMaterials.get(name).getAmbient()[1] + ", " + ListOfMaterials.get(name).getAmbient()[2] + " )" +
                                "\n diffuse = (" + ListOfMaterials.get(name).getDiffuse()[0] + ", " + ListOfMaterials.get(name).getDiffuse()[1] + ", " + ListOfMaterials.get(name).getDiffuse()[2] + " )" +
                                "\n specular = (" + ListOfMaterials.get(name).getSpecular()[0] + ", " + ListOfMaterials.get(name).getSpecular()[1] + ", " + ListOfMaterials.get(name).getSpecular()[2] + " )" +
                                "\n SpecCoef = " + ListOfMaterials.get(name).getSpecularCoefficient());*/
                        mtl = 0;
                    }
